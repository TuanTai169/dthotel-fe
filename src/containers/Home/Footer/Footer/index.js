			...
			<section className='footer'>
				<div className='footer__container'>
					...
					<div className='footer__container__infoterm'>
						<div className='footer__container__infoterm__title'>
							Hotel Information
						</div>
						<div className='footer__container__infoterm__items'>
							<Link
								className='footer__container__infoterm__item'
								to='/about-us'
							>
								About Us
							</Link>
					...
					<div className='footer__container__infoterm2'>
						...
						<div className='footer__container__infoterm2__items'>
							<Link
								className='footer__container__infoterm2__item'
								to='/privacy'
							>
								Privacy Policy
							</Link>
				...
				<div className='footer__otherinfor'>
					...
					<div className='footer__otherinfor__copyright'>
						COPYRIGHT © 2017 SAM TUYEN LAM
					</div>
				</div>
			</section>
		</div>
