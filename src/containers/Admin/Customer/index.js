...
function Customers() {
	...
	const isLoading = useSelector((state) => state.customerReducer.isCustomerLoading);
	...
	const currentData = useMemo(() => {
		let computedCustomers = [...customers].sort((a, b) => (a.createdAt < b.createdAt ? 1 : -1));
						...
						<div className='page__header'>
							...
							<div className='page__action'>
								<ButtonToolbar>
									...
									<AddCustomerModal show={isOpen} handlerModalClose={handlerModalClose} />
								</ButtonToolbar>
							</div>
						</div>
